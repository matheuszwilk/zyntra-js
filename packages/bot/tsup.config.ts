...
/**
 * tsup build configuration for @zyntra-js/bot
 *
 * Goals:
...
export default defineConfig({
  entry: {
    ...
    // Individual adapters (for @zyntra-js/bot/adapters/*)
    ...
    // Middlewares barrel (for @zyntra-js/bot/middlewares)
    'middlewares/index': 'src/middlewares/index.ts',

    // Plugins barrel (for @zyntra-js/bot/plugins)
    'plugins/index': 'src/plugins/index.ts',

    // Stores barrel (for @zyntra-js/bot/stores)
    'stores/index': 'src/stores/index.ts',

    // Types barrel (for @zyntra-js/bot/types)
...
*/`,
  ...
  onSuccess: 'echo Build completed for @zyntra-js/bot',
})
