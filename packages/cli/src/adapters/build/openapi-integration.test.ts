...
describe('OpenAPI Generator Integration - docs configuration', () => {
  it('should generate OpenAPI spec with docs configuration from router', () => {
      ...
      config: {
        ...
        docs: {
          info: {
            title: 'Test API',
            version: '1.0.0',
            description: 'A comprehensive test API for Zyntra.js',
          },
          servers: [
    ...
    } as ZyntraRouter<any, any, any, any, any>;
    ...
    expect(spec.info.description).toBe('A comprehensive test API for Zyntra.js');
  ...
  it('should handle missing docs configuration gracefully', () => {
    ...
    expect(spec.info.title).toBe('Zyntra API');
    expect(spec.info.version).toBe('1.0.0');
