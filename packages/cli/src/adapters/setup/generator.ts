...
export class ProjectGenerator {
  ...
  private async downloadTemplate(): Promise<{ isStarter: boolean, success: boolean }> {
    ...
    const templateUrl = `https://github.com/matheuszwilk/zyntra-js.git`
    const branch = 'main'
    const tempDir = path.join(this.targetDir, '__zyntra_tmp__')
  ...
  private async createProjectStructure(): Promise<void> {
    ...
    try {
      ...
      const dirs = [
        ...
        'src/features',
        'src/features/user',
        'src/features/user/controllers',
        'src/features/user/procedures',
        'src/services'
      ]
      ...
      if (['nextjs', 'vite', 'remix'].includes(this.config.framework)) {
        dirs.push(
          ...
          'src/features/user/presentation/components',
          'src/features/user/presentation/hooks',
          'src/features/user/presentation/contexts',
          'src/features/user/presentation/utils'
        )
      }
...
`
  ...
  private showSuccessMessage(): void {
    console.log()
    if (this.isExistingProject) {
      console.log(chalk.green('✓ Success! Zyntra.js has been added to your project!'))
    } else {
      console.log(chalk.green('✓ Success! Your Zyntra.js project is ready!'))
    }
    console.log()
    ...
    if (this.isExistingProject) {
      console.log()
      console.log(chalk.yellow('Remember to integrate the Zyntra router into your existing server setup!'))
    }
