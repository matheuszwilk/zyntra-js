...
/**
 * ANSI Art and branding for Zyntra.js
 */
const ZYNTRA_LOGO = `
${chalk.blue('┌')}${chalk.blue('─'.repeat(60))}${chalk.blue('┐')}
${chalk.blue('│')}${' '.repeat(21)}${chalk.bold.blue('⚡ ZYNTRA.JS')}${' '.repeat(20)}${chalk.blue('│')}
...
function showWelcome(): void {
  console.clear()
  console.log(ZYNTRA_LOGO)
  console.log()
  console.log(chalk.bold('Welcome to Zyntra.js!'))
  console.log()
...
export async function runSetupPrompts(
  ...
  const projectName = targetDir ? path.basename(path.resolve(targetDir)) : 'my-zyntra-app'
  ...
  try {
    const answers = await prompts([
      ...
      },
      {
        ...
        name: 'features',
        message: chalk.bold('• Which Zyntra.js features would you like to enable?'),
        choices: [
          {
    ...
    const featuresObj: ZyntraFeatures = {
