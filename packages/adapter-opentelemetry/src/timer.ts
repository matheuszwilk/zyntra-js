import type { ZyntraTimer } from '@zyntra-js/core';
...
/**
 * OpenTelemetry Timer wrapper that implements ZyntraTimer interface
 */
export class OpenTelemetryTimer implements ZyntraTimer {
 ...
 */
export class NoOpTimer implements ZyntraTimer {
