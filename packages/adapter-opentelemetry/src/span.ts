import type { ZyntraTelemetrySpan, ZyntraSpanOptions, ZyntraSpanContext } from '@zyntra-js/core';
import { ZyntraConsoleLogger, resolveLogLevel } from '@zyntra-js/core';
...
/**
 * OpenTelemetry Span wrapper that implements ZyntraTelemetrySpan interface
 */
export class OpenTelemetrySpanWrapper implements ZyntraTelemetrySpan {
  private _span: any;
  private _tracer: any;
 ...
 */
class NoOpSpan implements ZyntraTelemetrySpan {
  ...
  child(name: string): ZyntraTelemetrySpan {
    return new NoOpSpan(name);
  }
