...
- 3e7fb94: feat!: Next alpha update — major enhancements: modular adapters, advanced type-safe realtime and job systems, robust store layer, and extensible architecture for scalable, modern TypeScript backends
  ...
  - **Job System** (`@zyntra-js/adapter-bullmq`)
  ...
  - **Store Layer** (`@zyntra-js/adapter-redis`)
  ...
  - **Telemetry** (`@zyntra-js/adapter-opentelemetry`)
  ...
  - **MCP Server Integration** (`@zyntra-js/adapter-mcp`)
  ...
  npm install @zyntra-js/adapter-mcp @vercel/mcp-adapter @modelcontextprotocol/sdk
  ```
  ...
  - Completing the new ZyntraJS CLI for improved developer experience
