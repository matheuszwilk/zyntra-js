...
[![NPM Version](https://img.shields.io/npm/v/@zyntra-js/adapter-mcp-server.svg)](https://www.npmjs.com/package/@zyntra-js/adapter-mcp-server)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

The official Model Context Protocol (MCP) adapter for ZyntraJS. This package exposes your entire ZyntraJS API as a set of tools that can be consumed by MCP-compatible AI agents and applications.

## Role in the Ecosystem

This adapter transforms your ZyntraJS application into an AI-native tool server. It allows AI agents, such as those integrated into IDEs like Cursor, to understand and interact with your API endpoints as if they were native functions. This is a key part of the "AI-Friendly" philosophy of ZyntraJS, enabling powerful automated workflows.

## Installation

To use this adapter, you need to install it alongside `@zyntra-js/core`.
...
1. **Builder Pattern API** (`ZyntraMcpServer`) - **Recommended** for TypeScript projects with full type inference
...
import { AppRouter } from '@/zyntra.router'; // Import your main ZyntraJS router
...
For more detailed guides, please refer to the **[Official ZyntraJS Documentation](https://zyntrajs.com/docs)**.
