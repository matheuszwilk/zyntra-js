...
import type { ZyntraRouter, ContextCallback } from "@zyntra-js/core";
 ...
 */
export type McpToolFilter = (controller: string, action: string, actionConfig: ZyntraAction<any, any, any, any, any, any, any, any, any, any>) => boolean;

/**
 * Function type to transform tool configurations.
 */
export type McpToolTransform = (controller: string, action: string, actionConfig: ZyntraAction<any, any, any, any, any, any, any, any, any, any>) => McpToolConfig;
...
export interface McpResponseOptions<TContext = any> {
  /** Transform Zyntra response to MCP format */
  transform?: (zyntraResponse: any, toolName: string, context: McpContext<TContext>) => CallToolResult | Promise<CallToolResult>;
  /** Handle errors */
...
> {
  ...
  /** Zyntra router to expose as MCP server */
  router: TRouter;
 ...
 */
export type InferMcpContextFromRouter<TRouter> = TRouter extends ZyntraRouter<any, any, any, any, any>
  ? TRouter['$Infer']['$context']
  : never;

/**
 * MCP handler with optional authentication for ZyntraMcpServer
*/
export type ZyntraMcpHandler = {
