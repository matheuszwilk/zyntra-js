...
import { type EventCallback, type KeyValueOptions, type ZyntraStoreAdapter, isServer } from "@zyntra-js/core";

/**
 * Creates a Store Adapter for Redis.
 * This adapter provides a unified interface for Zyntra to interact with a Redis instance,
 ...
 */
export function createRedisStoreAdapter(redisClient: Redis): ZyntraStoreAdapter<Redis> {
  if (!isServer) {
    return {} as ZyntraStoreAdapter<Redis>;
  }
