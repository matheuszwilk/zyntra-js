...
<html>
  <head>
    <title>${docsConfig?.info?.title ?? 'Unnamed'} (${docsConfig?.info?.version ?? '1.0.0'}) - Zyntra Studio</title>
    <meta charset="utf-8" />
  ...
  <body>
    <header class="header">
      <img src="https://zyntrajs.com/logo-light.svg" alt="Zyntra Logo" />
      ...
      <div class="header-actions">
        <div class="social-links">
         ...
         <a href="https://zyntrajs.com" target="_blank" class="docs-link">
            <span>Powered By Zyntra.js</span>
...
class PlaygroundRequestHandler {
  ...
  async handle(request: Request, docsConfig?: DocsConfig, basePath?: string): Promise<Response> {
    try {
      ...
      logger.error('Error generating Zyntra Studio:', { error });
      return new Response('Internal Server Error', { status: 500 });
    }
  }
}

export function initializeZyntraPlayground(docsConfig?: DocsConfig, basePath?: string): {
