...
import { createZyntraQuery, createZyntraMutation } from '../action.service';
import type { StandardSchemaV1, ZyntraProcedure } from '../../types';
...
const createMockProcedure = (name: string): ZyntraProcedure<unknown, unknown, unknown> => ({
  name,
...
describe('Action Service', () => {
  describe('createZyntraQuery', () => {
    it('should create a query action with GET method', () => {
      const queryAction = createZyntraQuery({
        path: 'users',
        handler: mockHandler,
      });
    ...
    it('should preserve all provided options', () => {
      ...
      const queryAction = createZyntraQuery(options);
  ...
  describe('createZyntraMutation', () => {
    it('should create a mutation action preserving the method', () => {
      const mutationAction = createZyntraMutation({
        path: 'users',
        method: 'POST',
        handler: mockHandler,
      });
    ...
    it('should preserve all provided options including body and query', () => {
      ...
      const mutationAction = createZyntraMutation(options);
  ...
  describe('Type Safety and Structure', () => {
    ...
    it('should handle minimal query configuration', () => {
      const minimalQuery = createZyntraQuery({
        path: 'minimal',
        handler: vi.fn(),
      });
    ...
    it('should handle minimal mutation configuration', () => {
      const minimalMutation = createZyntraMutation({
        path: 'minimal',
        method: 'POST',
        handler: vi.fn(),
      });
