...
import { createZyntraJobsService, createJobDefinition, createJobsRouter } from '../jobs.service'
import type { ZyntraJobQueueAdapter, JobDefinition, JobsRouter } from '../../types/jobs.interface'
import { z } from 'zod'

// Mock adapter for testing
const createMockAdapter = (): ZyntraJobQueueAdapter<any> => ({
  client: {},
...
describe('Jobs Service', () => {
  let mockAdapter: ZyntraJobQueueAdapter<TestContext>
  ...
  describe('Service Creation', () => {
    test('should create jobs service with adapter and context factory', () => {
      const service = createZyntraJobsService({
        adapter: mockAdapter,
        contextFactory
      })
