...
describe('Realtime Service', () => {
  ...
  let realtimeService: ZyntraRealtimeService<TestContext>;
  ...
  beforeEach(() => {
    ...
    realtimeService = new ZyntraRealtimeService(mockStore);
  });

  describe('ZyntraRealtimeService Construction', () => {
    it('should create realtime service with store adapter', () => {
      expect(realtimeService).toBeInstanceOf(ZyntraRealtimeService);
    });
