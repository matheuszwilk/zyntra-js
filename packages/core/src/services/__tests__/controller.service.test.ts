...
describe('Controller Service', () => {
  describe('createZyntraController', () => {
    it('should return the exact configuration passed to it', () => {
      ...
      // @ts-expect-error - Testing with simplified mock actions, not full ZyntraAction objects
      const controller = createZyntraController(config);
  ...
  describe('Type Safety and Structure', () => {
    it('should maintain the exact structure of the input configuration', () => {
      ...
      const controller = createZyntraController(originalConfig as any);
    ...
    it('should not modify the input configuration', () => {
      ...
      // @ts-expect-error - Testing with simplified mock actions, not full ZyntraAction objects
      const controller = createZyntraController(originalConfig);
  ...
  describe('Edge Cases', () => {
    it('should handle null-like values in configuration', () => {
      ...
      const controller = createZyntraController(config as any);
