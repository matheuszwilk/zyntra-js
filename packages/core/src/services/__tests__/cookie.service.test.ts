...
import { ZyntraCookie } from '../cookie.service';
...
describe('Cookie Service', () => {
  ...
  let cookies: ZyntraCookie;

  beforeEach(() => {
    vi.clearAllMocks();
    headers = new MockHeaders();
    cookies = new ZyntraCookie(headers as any);
  });

  describe('ZyntraCookie Construction', () => {
    it('should create cookie instance with empty headers', () => {
      const emptyHeaders = new MockHeaders();
      const emptyCookies = new ZyntraCookie(emptyHeaders as any);
    ...
    it('should parse existing cookies from headers', () => {
      ...
      const parsedCookies = new ZyntraCookie(headersWithCookies as any);
    ...
    it('should handle malformed cookie headers gracefully', () => {
      ...
      const parsedCookies = new ZyntraCookie(malformedHeaders as any);
    ...
    it('should handle empty cookie header', () => {
      ...
      const parsedCookies = new ZyntraCookie(emptyHeaders as any);
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle missing headers gracefully', () => {
      ...
      const nullCookies = new ZyntraCookie(nullHeaders as any);
