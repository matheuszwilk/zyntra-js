...
describe('Procedure Service - Legacy API', () => {
  describe('createZyntraProcedure', () => {
    it('should create a basic procedure with legacy API', () => {
      const mockHandler = vi.fn().mockResolvedValue({ success: true });
      
      const procedureConfig: ZyntraProcedure<TestContext, undefined, { success: boolean }> = {
        name: 'test-procedure',
        handler: mockHandler
      };

      const procedureFactory = createZyntraProcedure(procedureConfig);
    ...
    it('should create procedure with options', () => {
      ...
      const procedureConfig: ZyntraProcedure<TestContext, TestOptions, { configured: boolean }> = {
    ...
    it('should execute procedure handler with correct context', async () => {
      ...
      const procedureConfig: ZyntraProcedure<TestContext, { flag: boolean }, { executed: boolean }> = {
    ...
    it('should handle procedure without options', async () => {
      ...
      const procedureConfig: ZyntraProcedure<TestContext, undefined, { simple: boolean }> = {
    ...
    it('should handle synchronous procedure handlers', () => {
      ...
      const procedureConfig: ZyntraProcedure<TestContext, undefined, { sync: boolean }> = {
        name: 'sync-procedure',
        handler: mockHandler
      };
