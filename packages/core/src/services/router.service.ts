import type { ContextCallback, DocsConfig, ZyntraBaseConfig, ZyntraControllerConfig, ZyntraRouter } from "../types";
...
import { initializeZyntraPlayground } from "./playground.service";
import { ZyntraConsoleLogger } from "./logger.service";
import { resolveLogLevel, createLoggerContext } from "../utils/logger";


/**
 * Creates a fully-typed, production-ready router instance for the Zyntra Framework.
 *
 ...
 * ```typescript
 * import { createZyntraRouter } from "@zyntra-js/core";
 * import { userController } from "./controllers/user.controller";
 *
 * const router = createZyntraRouter({
 *   context: async (req) => ({
 ...
 * @template TConfig extends ZyntraBaseConfig - The router configuration object
 * @template TPlugins extends Record<string, ZyntraPlugin<any, any, any, any, any, any, any, any>> - Record of plugins available in this router
 *
 ...
 *
 * @returns A fully-configured, type-safe ZyntraRouter instance:
 ...
 * ---
 * ## See Also
 * - [Controller Documentation](https://zyntrajs.dev/docs/controllers)
 * - [Plugin System](https://zyntrajs.dev/docs/plugins)
 * - [Context Patterns](https://zyntrajs.dev/docs/context)
 * - [Testing Guide](https://zyntrajs.dev/docs/testing)
 */
export const createZyntraRouter = <
  TContext extends object | ContextCallback,
  TControllers extends Record<string, ZyntraControllerConfig<any>>,
...
>({
  ...
  plugins?: TPlugins;
  docs?: TDocs;
}): ZyntraRouter<TContext, TControllers, TConfig, TPlugins, TDocs> => {
  type TRouter = ZyntraRouter<TContext, TControllers, TConfig, TPlugins, TDocs>;
  ...
  return {
    ...
    handler: async (request: Request) => {
      ...
      if (path.startsWith(parseURL(basePath, playgroundPath))) {
        ...
        const playground = initializeZyntraPlayground(docs, basePath);
        try {
