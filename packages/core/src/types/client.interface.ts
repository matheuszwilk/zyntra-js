...
/**
 * Zyntra.js Client Interface Definitions
 *
 * This module contains all type definitions for the Zyntra.js client-side implementation.
 * The client is a completely custom implementation built from scratch specifically for Zyntra.js,
 * providing end-to-end type safety and seamless integration with the Zyntra.js backend.
 *
 * Key Features:
...
export type ClientConfig<TRouter extends ZyntraRouter<any, any, any, any, any>> = {
...
export type InferAllActionPaths<TRouter extends ZyntraRouter<any, any, any, any, any>> = {
...
export type InvalidateFunction<TRouter extends ZyntraRouter<any, any, any, any, any>> = {
