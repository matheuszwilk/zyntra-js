import { createZyntraPlugin, createZyntraPluginAction } from "../types/plugin.interface";
import { z } from "zod";
...
export const audit = createZyntraPlugin<AuditContext>({
  name: "audit",
  $meta: {
    version: "1.0.0",
  ...
  $actions: {
    create: createZyntraPluginAction({
      name: "create",
    ...
    store: createZyntraPluginAction({
      name: "store",
    ...
    getUserLogs: createZyntraPluginAction({
      name: "getUserLogs", 
  ...
  registration: {
    ...
    author: "Zyntra Team",
    repository: "https://github.com/zyntra-js/zyntra",
    documentation: "https://docs.zyntra-js.dev/plugins/audit",
  },
