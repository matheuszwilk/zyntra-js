...
import { ZyntraLogLevel, type ZyntraLogger } from "../types";
 ...
 */
class ConsoleTelemetrySpan implements ZyntraTelemetrySpan {
 ...
 */
class ConsoleTelemetryTimer implements ZyntraTimer {
  public readonly name: string;
  public readonly startTime: number;
 ...
 */
class ConsoleTelemetryProvider implements ZyntraTelemetryProvider {
  public readonly config: ZyntraTelemetryConfig;
  public readonly name = 'console';
  public readonly status: 'active' | 'inactive' | 'error' = 'active';
  
  private activeSpan: ZyntraTelemetrySpan | null = null;
  private spanStack: ZyntraTelemetrySpan[] = [];
  private store?: ZyntraStoreAdapter;
  private enableCliIntegration: boolean;
  private channel: string;
  private logger: ZyntraLogger = new ZyntraConsoleLogger({
    level: resolveLogLevel(),
    context: createLoggerContext('ConsoleTelemetryProvider')
  })

  constructor(
    config: ZyntraTelemetryConfig, 
    ...
    this.channel = options.channel ?? 'zyntra:telemetry';
