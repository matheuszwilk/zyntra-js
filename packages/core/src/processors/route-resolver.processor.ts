...
import { ZyntraLogLevel, type ZyntraAction, type ZyntraLogger } from "../types";
...
export interface RouteResult {
  success: boolean;
  action?: ZyntraAction<any, any, any, any, any, any, any, any, any, any>;
...
/**
 * Route resolver processor for the Zyntra Framework.
...
export class RouteResolverProcessor {
  ...
  static resolve(
    ...
    return {
      success: true,
      action: route.data as ZyntraAction<any, any, any, any, any, any, any, any, any, any>,
      params: finalParams
    };
  }
}
