...
describe('ErrorHandlerProcessor', () => {
  ...
  describe('handleError', () => {
    ...
    test('should handle ZyntraError', async () => {
      const zyntraError = new ZyntraError({
        message: 'Not found',
        code: 'NOT_FOUND',
      });
  ...
  describe('handleZyntraError', () => {
    test('should format ZyntraError response', async () => {
      const error = new ZyntraError({
      ...
      const context = createMockContext();
      const result = await ErrorHandlerProcessor['handleZyntraError'](
        error,
        context,
        mockTelemetrySpan as any,
        Date.now()
