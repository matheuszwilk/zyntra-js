...
Job definitions are the foundation of the ZyntraJS Jobs system. They define what data a job accepts, how it executes, and how it behaves under different conditions.
