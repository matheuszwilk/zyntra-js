...
const packages = [
  {
    ...
    link: "https://github.com/matheuszwilk/zyntra-js/tree/main/packages/core"
  },
  {
    name: "Zyntra CLI",
    ...
    link: "https://github.com/matheuszwilk/zyntra-js/tree/main/packages/cli"
  },
  {
    name: "Zyntra Queues",
...
const starterKits = [
  {
    ...
    description: "Full-stack Next.js application with Zyntra.js backend",
    icon: (
      <svg className="w-12 h-12" viewBox="0 0 50 50" fill="none">
  ...
  },
  {
    ...
    description: "Traditional Express.js REST API with Zyntra.js",
    icon: (
      <svg className="w-12 h-12" viewBox="0 0 50 50" fill="none">
        <rect width="50" height="50" rx="8" fill="#000000"/>
...
const products = [
  ...
  {
    name: "Zyntra Studio",
    description: "Visual development environment for Zyntra.js applications",
    status: "coming-soon",
    link: "#"
  },
  {
