...
export function ProjectBuilder({ template }: ProjectBuilderProps) {
  ...
  const generateCommand = () => {
    let command = `npx @zyntra-js/cli init ${config.projectName}`;
...
Built with @zyntrajs and an amazing stack: ${stackNames}
            ...
            <div className="relative">
              ...
              {isStarter && (
                <section className="relative">
                  ...
                  <div className="ml-12 space-y-6">
                    <div>
                      <h3 className="text-sm">Zyntra.js Features</h3>
                    </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-2">
                          ...
                          <Button
                            onClick={() => {
                              const text = encodeURIComponent(generateSocialPost());
                              window.open(`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent('https://zyntrajs.dev')}&summary=${text}`, '_blank');
                            }}
                            size="sm"
                            variant="outline"
                            className="rounded-full w-fit"
                          ...
                          <Button
                            onClick={() => {
                              ...
                              if (navigator.share) {
                                navigator.share({
                                  title: 'My new Zyntra.js project',
                  ...
                  <section className="relative">
                    ...
                    <div className="ml-12 space-y-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        <Button
                          onClick={() => {
                            window.open('https://github.com/matheuszwilk/zyntra-js', '_blank');
                          }}
                          size="sm"
                          variant="outline"
                          className="rounded-full w-fit"
                        ...
                        <Button
                          onClick={() => {
                            window.open('https://zyntrajs.dev/docs', '_blank');
                          }}
                          size="sm"
                          variant="outline"
                          className="rounded-full w-fit"
                        ...
                        <Button
                          onClick={() => {
                            window.open('https://zyntrajs.dev/examples', '_blank');
                          }}
                          size="sm"
                          variant="outline"
                          className="rounded-full w-fit"
                        ...
                        <Button
                          onClick={() => {
                            window.open('https://zyntrajs.dev/changelog', '_blank');
                          }}
                          size="sm"
                          variant="outline"
                          className="rounded-full w-fit"
