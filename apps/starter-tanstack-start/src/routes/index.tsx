...
import { ArrowRight, Code2, FileText, ArrowUpRight } from "lucide-react"
      ...
      <header className="border-b bg-black/5 w-full border-x px-3 flex items-center justify-between space-x-4">
        <div className="border-x w-full py-[0.5rem] px-[1rem] flex items-center justify-between space-x-4">
          <div className="flex items-center space-x-2">
            <img src="https://zyntrajs.com/logo-light.svg" alt="" className="h-5 invert-1 dark:invert-0" />
          </div>

          <div className="flex items-center space-x-4">
            <a href="https://github.com/matheuszwilk/zyntra-js" target="_blank">
            ...
            <a href="https://twitter.com/zyntrajs" target="_blank">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
                <path
            ...
            <Button variant="outline" className="bg-transparent rounded-full !px-5 uppercase font-mono h-6" asChild>
              <a href="/api/v1/docs" target="_blank">
                <span className="opacity-60 text-[10px]">Open Zyntra Studio</span>
              ...
              <Card className="shadow-sm hover:shadow-md transition-shadow bg-transparent">
                <CardContent className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Explore our documentation covering Zyntra.js features, API references, and tutorials.
                  </p>
                  <Button variant="outline" className="w-full !mt-8" asChild>
                    <a href="https://zyntrajs.com/docs" target="_blank">
                      Read Docs
            ...
            <article>
              <Card className="shadow-sm hover:shadow-md transition-shadow bg-transparent">
                <CardContent className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Start your journey with Zyntra.js by exploring our quick start guide with step-by-step instructions.
                  </p>
                  <Button variant="outline" className="w-full !mt-8" asChild>
                    <a href="https://zyntrajs.com/docs/getting-started/quick-start-guide" target="_blank">
                      Get Started
                      <ArrowRight className="w-4 h-4 ml-auto" aria-hidden="true" />
                    </a>
                  </Button>
