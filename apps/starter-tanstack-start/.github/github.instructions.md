# AI Agent Maintenance Manual: ZyntraJS Starter (TanStack Start)

This document provides a technical guide for Large Language Model (LLM) based AI agents responsible for maintaining, debugging, and extending the **ZyntraJS Starter for TanStack Start**.
...
### 1.1. Name
ZyntraJS Starter: TanStack Start Full-Stack App

### 1.2. Purpose
This project is a modern, full-stack application template built on **TanStack Start**. It integrates an **ZyntraJS** API backend, providing a seamless, end-to-end type-safe development experience powered by Vite and file-based routing.
...
-   **Language**: TypeScript
-   **Caching**: Redis (via `@zyntra-js/adapter-redis`)
