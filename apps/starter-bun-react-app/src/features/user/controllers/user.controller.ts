    ...
    actions: {
        ...
        list: zyntra.query({
            ...
            handler: async ({ response, context }) => {
                // Business Logic: Use the injected user methods to fetch all records.
        ...
        getById: zyntra.query({
            ...
            handler: async ({ request, response, context }) => {
                ...
                // Business Logic: Attempt to find the user by ID via the injected methods.
                const record = await context.user.findUnique(id);
        ...
        create: zyntra.mutation({
            ...
            handler: async ({ request, response, context }) => {
                ...
                const record = await context.user.create(data);
        ...
        update: zyntra.mutation({
            ...
            handler: async ({ request, response, context }) => {
                ...
                // Business Logic: Attempt to update the user record via the injected methods.
                try {
                    const record = await context.user.update(id, data);
        ...
        delete: zyntra.mutation({
            ...
            handler: async ({ request, response, context }) => {
                ...
                // Business Logic: Use the injected methods to delete the user record.
                try {
