# ZyntraJS Real-Time Chat Example

[![ZyntraJS](https://img.shields.io/badge/ZyntraJS-v1-blue.svg)](https://zyntrajs.com/)
[![Next.js](https://img.shields.io/badge/Next.js-14-blue.svg)](https://nextjs.org/)
[![React](https://img.shields.io/badge/React-18-blue.svg)](https://reactjs.org/)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0%2B-blue.svg)](https://www.typescriptlang.org/)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

Welcome to the ZyntraJS Real-Time Chat Example! This project demonstrates how to build a full-stack, type-safe, real-time chat application using **ZyntraJS**, **Next.js**, and **Prisma**. It serves as a practical example of how to leverage ZyntraJS for building modern, high-performance web applications.
...
1.  **Clone the Repository**
    ```bash
    git clone https://github.com/matheuszwilk/todo-zyntra-project.git
    cd todo-zyntra-project
    ```
...
This starter deeply integrates ZyntraJS with the Next.js App Router to create a real-time chat application.

### 1. The Next.js API Route Handler

The entry point for all API requests is the catch-all route handler located at `src/app/api/[[...all]]/route.ts`. This file uses the `nextRouteHandlerAdapter` from ZyntraJS to expose the entire API.
...
// The adapter creates GET, POST, etc. handlers from your ZyntraJS router.
...
-   **Initialization (`src/zyntra.ts`)**: This is where the core Zyntra instance is created.
-   **Router (`src/zyntra.router.ts`)**: This file defines all API controllers.
...
│       └── [[...all]]/
│           └── route.ts  # ZyntraJS API entry point
...
To learn more about ZyntraJS and its powerful features, check out the official resources:

-   **[ZyntraJS Website](https://zyntrajs.com/)**
-   **[ZyntraJS GitHub Repository](https://github.com/matheuszwilk/zyntra-js)**
-   **[Follow on X](https://x.com/ZyntraJs)**
